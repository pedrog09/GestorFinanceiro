...
using Swashbuckle.AspNetCore.SwaggerGen; // Adicione esta diretiva de namespace para habilitar o m�todo de extens�o AddSwaggerGen.
...
namespace GestorFinanceiro 
{
    public class Program
    {
        public static void Main(string[] args) 
        {
            ...
            {
                app.UseSwagger(); // Corrige o m�todo para habilitar Swagger.
